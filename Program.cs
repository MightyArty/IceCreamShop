...
do
{
    ...
    Console.WriteLine("4 - generate total sales");
    ...
    Console.WriteLine("8 - show completed/uncompleted orders");
    ...
    Console.WriteLine("12 - generate the most common ingridients");
    ...
    switch (userInput)
    {
        ...
        case 2:
            ...
            break;
        case 3:
            Console.WriteLine("Please enter costumer ID (for the inovice)");
            int costumer_id = Int32.Parse(Console.ReadLine());
            string o = MySqlAccess.MySqlAccess.invoice(costumer_id);
            Console.WriteLine(o);
            break;
        case 4:
            Console.WriteLine("Please enter date in format MM/dd/yyyy (for the total sales)");
        ...
        case 7:
            ...
            break;
        case 8:
            Console.WriteLine("chose orders status(completed= 1/ uncompleted = 0)");
